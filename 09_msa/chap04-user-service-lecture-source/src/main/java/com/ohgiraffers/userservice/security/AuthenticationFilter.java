 ...
 *          : 사용자 정의 클레임으로 공개용 정보를 위해 사용(충돌 방지를 위해 URI로 구성)     -> 보통 URI로 함 아예 안 겹치게
 * 필기.
...
//        System.out.println("authResult = " + authResult);
        ...
        // 이렇게 넘어옴
        // 시크릿 키: l1Z5I9WufSD5qM0UTHXDJa1kaGxBlyhKMbx+ONkqzeRTlKdF8Bq37mA3Z8nhjRlwVUrL/u3bdkFeamIrUoWvVw==
        ...
        String token = Jwts.builder()
                ...
                .signWith(SignatureAlgorithm.HS512, environment.getProperty("token.secret"))            // 여기가 토큰을 만들어서 보낸 것
                .compact();

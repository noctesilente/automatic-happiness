...
public class RedirectServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 결과: 리다이렉트 이후 request의 attribute: null
        // 처음에 있었던 request랑 response는 두번째로 요청할 때 사라짐
        // 유지되지 않고 중간에 응답받았다가 재요청을 하기 때문에 request가 두 개 쓰인 것
        // 그래서 처음에 담았던 것은 웹 브라우저로 돌아가자마자 사라짐
         ...
         *
         * 설명.
         *  추가로, cookie나 session 같은 공간을 활용하는 방법을 사용해서 값을 공유할 수도 있다.
        * */
